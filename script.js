    ...
    function placeOrder(index) {
      ...
      if (item) {
        alert(`Yay! Your order for ${item.name} has been successfully placed. You'll hear from us soon!`);
      } else {
        alert("Oops! Something went wrong. The item could not be found.");
      }
    }
    ...
    function submitQuery(event) {
      ...
      if (name.trim() && email.trim() && query.trim()) {
        ...
        alert(`Thank you, ${name}! Your query has been submitted. We'll reach out soon!`);
